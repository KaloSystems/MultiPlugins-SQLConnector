...
/**
 * Projekt : MultiPlugins
 * Package : de.kalo.mysql.utils
 * Klasse : SQL
 * SQL erstellt am 03.06.2021 (Donnerstag) um 20:16
 * © Plugin by HTTPKalo
 */
public class SQL {
    ...
    public void createTable(String table_name, String table_type){
        MySQL.getInstance().update("CREATE TABLE IF NOT EXISTS " + table_name + "(" + table_type + ")");
        System.out.println("[MySQL] Connection with Table " + table_name + " online!");
    }
}
